            ...
            if (itemInInventory == true)
            {
                ...
                if (CurrentRoom.items != null && itemInInventory == true)
                {
                    while (itemFound == false && index < CurrentRoom.items.Count)
                    {
                        ...
                        {
                            if (CurrentRoom.items[index].Class != null && CurrentRoom.items[index].Class == "Interaction Object" && Player.inventory[ItemFoundAt].Name.ToLower() == CurrentRoom.items[index].ItemNeeded.ToLower())
                            {
